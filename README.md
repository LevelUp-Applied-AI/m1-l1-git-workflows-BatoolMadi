...
This project analyzes hospital admission records to identify patterns in patient admissions and healthcare resource usage. The goal is to create a reproducible analysis environment for the team.
